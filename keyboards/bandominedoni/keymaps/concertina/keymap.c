...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_OPEN] = LAYOUT(
      ...
      XXXXXXX, MY_Gs3, MY_Fs3, MY_A3, MY_C4, MY_E4, MY_Fs4, \
     ...
     XXXXXXX, MI_G1, MI_B1, MI_D2, MI_F2, MI_A2, MI_C3, XXXXXXX, \
       MI_A1, MI_Fs2, MI_A2, MI_C3, MI_E3, MI_Gs2, XXXXXXX, XXXXXXX, \
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MI_C2, XXXXXXX, XXXXXXX \
    ),
    ...
    [_CLOSE] = LAYOUT(
       ...
       XXXXXXX, MY_As3, MY_G3, MY_B3, MY_D4, MY_G4, MY_B4, \
     ...
     XXXXXXX, MI_C1, MI_G1, MI_C2, MI_E2, MI_G2, MI_As2, XXXXXXX, \
       MI_B1, MI_D2, MI_G2, MI_B2, MI_D3, MI_F2, XXXXXXX, XXXXXXX, \
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MI_C2, XXXXXXX, XXXXXXX \
    ),
